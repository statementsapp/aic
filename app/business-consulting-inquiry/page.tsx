...
export default function BusinessConsultingInquiry() {
  ...
  const t = translations[language].businessConsultingInquiry;
  ...
  const getInputClasses = () => {
    switch (theme) {
      case 'modern':
        return 'bg-gray-700 text-white border-gray-600 focus:border-gray-500';
      case 'vibrant':
        return 'bg-red-500 text-white border-red-400 focus:border-yellow-400';
      default:
